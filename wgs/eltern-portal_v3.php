...
/*if($username == "sese.tailor@gmail.com" || $username == "kugelmann.dennis@gmail.com") { exit('{
	"login": true,
	"children": [{
		...
		"representation": {
			...
			"tomorrow": {
				"date": "Mi., 14.09.2016 - KW 37",
				"data": []
			},
			"lastrefresh": " Letzte Aktualisierung: 13.09.2016 21:20:15"
		}
	}, {
		"name": "Maria Mustermann, 10",
		"timetable": {
			"monday": ["L", "G", "F", "B", "MU", "", "SOZ", "SOG", "M", "C", ""],
			"tuesday": ["WR", "PH", "D", "E", "M", "G", "", "", "", "", ""],
			"wednesday": ["E", "REL", "C", "SOG", "F", "IM", "", "", "", "", ""],
			"thursday": ["NUT", "SOZ", "SPO", "SPO", "REL", "", "D", "E", "WR", "", ""],
			"friday": ["PH", "B", "M", "D", "F", "KU", "", "", "", "", ""]
		},
		"representation": {
			"today": {
				"date": "Di., 13.09.2016 - KW 37",
...
foreach ($childs as $child) {
	...
	if(curl_exec($ch) == 1){
		...
		/*$representation = '{
			"today": {
				"date": "--., 00.00.0000 - KW 37",
				"data": [{
					"lesson": "1",
					"subject": "Fehler im Elternportal",
					"teacher": "-",
					"room": "A000"
				}]
			},
